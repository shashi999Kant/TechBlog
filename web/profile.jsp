...
<%@page import="com.tech.blog.entities.Massege"%>
...
<html>
    ...
    <body>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item active">
                        <a class="nav-link" href="#"> <i class="fa fa-code"></i> code with shashi <span class="sr-only">(current)</span></a>
                    </li>
        ...
        <%
            Massege m = (Massege) session.getAttribute("msg");
            if (m != null) {
